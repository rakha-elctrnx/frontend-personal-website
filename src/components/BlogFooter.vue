...
<template>
    <!-- Footer -->
    <footer class="i_ iz lf">
        <div class="on">
            <div class="ov cu cv cm">

                <!-- Social links -->
                <ul class="tz tu cn ci cs io">
                    <li>
                        <a class="tq rk rw uu fl at ar as" href="#0" aria-label="Twitter">
                            <svg class="nb nf sv" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <li>
                        <a class="tq rk rw uu fl at ar as" href="#0" aria-label="YouTube">
                            <svg class="nb nf sv" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <li>
                        <a class="tq rk rw uu fl at ar as" href="#0" aria-label="Github">
                            <svg class="nb nf sv" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <li>
                        <a class="tq rk rw uu fl at ar as" href="#0" aria-label="Telegram">
                            <svg class="nb nf sv" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <!-- Copyright -->
                <div class="ob uf lb">Copyright ©ActyTauri. All rights reserved.</div>
